  ...
  return (
    <header className='text-white text-opacity-80' id='home'>
        ...
        <div className='flex flex-col gap-3 text-center'>
          ...
          <div className='flex justify-between gap-3 mt-3'>
            <a
              ...
              href='https://drive.google.com/file/d/1csumvt29cJ068uP1wNjd-E2bDDshWf3f/view?usp=drive_link'
      ...
      <div className='flex flex-col gap-3 absolute left-2 md:left-1/4 -translate-y-40'>
        <a href='https://wa.me/+2349028686300' target='_blank'rel="noopener noreferrer">
          <AiOutlineWhatsApp className='text-2xl text-primary-color hover:text-white' />
        </a>
        <a href='https://www.linkedin.com/in/daniel-idowu/' target='_blank'rel="noopener noreferrer">
          <AiOutlineLinkedin className='text-2xl text-primary-color hover:text-white' /> 
        </a>
        <a href='https://github.com/daniel-idowu-01' target='_blank'rel="noopener noreferrer">
